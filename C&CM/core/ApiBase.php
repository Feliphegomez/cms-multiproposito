<?php
/**
 * PHP-REST-API (v3)              License: MIT
 * FelipheGomez: feliphegomez@gmail.com
 * https://github.com/Feliphegomez/api-rest-php
 *
 * Congrulations:
 * - Nyholm\*: PHP-FIG :: https://github.com/php-fig
 * - Psr\*: Tobias Nyholm :: https://github.com/Nyholm
 **/
...
namespace FelipheGomez\PhpCrudApi\Database {
    ...
    class GenericDB
    {
        ...
        private function getDsn(): string
        {
            switch ($this->driver) {
                case 'mysql':
                    return "$this->driver:host=$this->address;port=$this->port;dbname=$this->database;charset=" . DB_charset;
                case 'pgsql':
...
namespace FelipheGomez\PhpCrudApi\Record {
    ...
    class ErrorCode
    {
        ...
        private $values = [
            9999 => ["Error: %s ", ResponseFactory::INTERNAL_SERVER_ERROR],
